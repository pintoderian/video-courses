<header class="border-b">
  ...
  <div class="container mx-auto px-4 py-4 flex items-center justify-between">
    ...
    <form class="hidden md:flex items-center space-x-4 flex-1 max-w-sm lg:max-w-xl mx-4" action="/search" method="get">
      <input type="search" placeholder="Search for anything" name="q"
