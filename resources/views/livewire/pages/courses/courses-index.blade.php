<x-slot name="header">
    <div class="flex justify-between">
        ...
        <x-link-button href="/dashboard/courses/create">Create +</x-link-button>
    </div>
</x-slot>
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">{{ $course->slug }}</td>
                                <td class="px-6 py-4">
                                    <div class="flex flex-row gap-4">
                                        <!-- Edit Button -->
                                        <x-link-button href="{{ route('courses.edit', $course) }}">Edit</x-link-button>
                                        <!-- Delete Form -->
                                        <x-secondary-button wire:click="delete({{ $course->id }})">
                                            Delete
                                        </x-secondary-button>
                                    </div>
                                </td>
